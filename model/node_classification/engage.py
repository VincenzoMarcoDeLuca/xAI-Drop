...
class Encoder(torch.nn.Module):
    def __init__(self, in_channels, coder_hid_num, out_channels, activation,
                 base_model=GCNConv, k = 2, num_classes = 7):
...
class ModelSIM(torch.nn.Module):
    def __init__(self, encoder: Encoder, prejector: prediction_MLP, predictor: projection_MLP, num_classes: int):
    ...
    def predict_class(self, x: torch.Tensor, edge_index:torch.Tensor) ->torch.Tensor():
