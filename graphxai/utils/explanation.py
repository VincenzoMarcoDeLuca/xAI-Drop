...
class EnclosingSubgraph:
    ...
    def __init__(self, 
            ...
            edge_mapping: torch.LongTensor = None,
...
class Explanation:
    ...
    def set_enclosing_subgraph(self, subgraph, mapping, edge_mapping = None):
        '''
        Args:
        ...
        if isinstance(subgraph, EnclosingSubgraph):
            ...
            self.enc_subgraph = EnclosingSubgraph(*subgraph, mapping, edge_mapping)
